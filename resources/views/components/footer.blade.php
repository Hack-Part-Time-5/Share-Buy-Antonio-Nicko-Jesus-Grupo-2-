...
<div class="container-fluid d-flex justify-content-center flex-column p-5">
    <div class="row row-cols-1 row-cols-sm-12 row-cols-md-5 py-5 my-5 border-top">
      ...
      <div class="col mb-3">
        ...
        <ul class="nav flex-column my-3">
          ...
          <li class="nav-item mb-2"><a href="{{route('revisor.become')}}" class="btn btn-danger nav-link p-0 m text-muted">Trabaja con nosotros</a></li>
