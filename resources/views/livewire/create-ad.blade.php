<div>
    ...
    <form wire:submit.prevent="store">
        ...
        <div class="mb-3">
            <label for="title" class="form-label">¿Qué estás vendiendo?</label>
        ...
        <div class="mb-3">
            <input type="file" wire:model="temporary_images" name="images" multiple class="form-control shadow @error('temporary_images.*') is-invalid @enderror">
